<header class="mextreo-header-area">
  <div class="container c-fulid-max">
          ...
          <div class="mxm-wrspper">
            <nav class="main-nav" role="navigation">
              ...
              <ul id="main-menu" class="sm sm-mint">
                ...
                <li>
                  <a data-toggle="modal" data-target=".contact-popup" class="tes btn-close" href="#">Contacto</a>
                </li>
                ...
                <li><a data-toggle="modal" data-target=".lang-popup" class="btn-close" href="#">Ing/Esp</a></li>
              </ul>
            </nav>
          </div>
          <!---<div class="side-ber">
    ...
    <!-- Modal Lang -->
    <div class="modal fade lang-popup" id="langModalCenter" tabindex="-1" role="dialog" aria-labelledby="langModalCenterTitle" aria-hidden="true">
